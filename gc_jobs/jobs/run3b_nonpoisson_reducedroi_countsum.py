...
def run_sims(num_sims):
    ...
    def simulator(params):
        ...
        heatmap = my_LFI.get_roi_map_summary(obs_photon_info, N_side, N_Ebins, Ebinspace = 'log')
        heatmap = my_LFI.get_counts_histogram_from_roi_map(heatmap, mincount, maxcount, N_countbins, countbinspace = 'log')
...
if (__name__=="__main__"):
    ...
    path = '/home/chri3448/EPDF_ABC/gc_jobs/simulations/run3b_nonpoisson_reducedroi_countsum'
