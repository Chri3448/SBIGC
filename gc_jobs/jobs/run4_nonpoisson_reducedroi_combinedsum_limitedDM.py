...
def run_sims(num_sims):
    ...
    parameter_range[0].append(400000.)
    parameter_range[1].append(800000.)
...
if (__name__=="__main__"):
    ...
    path = '/home/chri3448/EPDF_ABC/gc_jobs/simulations/run4_nonpoisson_reducedroi_combinedsum_limitedDM'
