...
def run_sims(num_sims):
    ...
    parameter_range[0].append(500000.)
    parameter_range[1].append(1000000.)
    parameter_names.append(r'\langle\sigma_{DM} v\rangle_0')
    parameter_range[0].append(0.)
    parameter_range[1].append(30.0)
    DM_als = [DM_wrap]
...
if (__name__=="__main__"):
    ...
    path = '/home/chri3448/EPDF_ABC/gc_jobs/simulations/run4_nonpoisson_reducedroi_combinedsum_extendedDM2'
