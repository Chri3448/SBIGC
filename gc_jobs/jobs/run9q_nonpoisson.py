...
def run_sims(num_sims):
    ...
    parameter_names.append(r'\langle\sigma_{DM} v\rangle_0/m_{\chi}^2')
    ...
    def simulator(params):
        ...
        obs_photon_info = my_LFI.apply_PSF(obs_photon_info, obs_info, single_energy_psf = True, single_energy_value = 4500)
...
if (__name__=="__main__"):
    ...
    path = '/home/chri3448/EPDF_ABC/gc_jobs/simulations/run9q_nonpoisson'
