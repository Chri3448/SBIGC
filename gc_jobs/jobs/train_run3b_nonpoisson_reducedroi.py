...
MO_ics_map, MO_ics_energies, MO_ics_indices = my_MO.get_partial_map_ics(angular_cut, energy_range[0], energy_range[1], N_Ebins_MO, N_side_MO)
...
MO_pibrem_map, MO_pibrem_energies, MO_pibrem_indices = my_MO.get_partial_map_pibrem(angular_cut, energy_range[0], energy_range[1], N_Ebins_MO, N_side_MO)
...
FBub_map, FBub_energies, FBub_indices = my_FBub.get_partial_map(angular_cut, energy_range[0], energy_range[1], N_Ebins_FBub, N_side_FBub)
...
load_sims = True
posterior_file = 'posteriors/run3b_nonpoisson_reducedroi/1000000sims'
sim_dir = 'simulations/run3b_nonpoisson_reducedroi/'
if load_posterior:
