...
def run_sims(num_sims):
    ...
    def simulator(params):
        ...
        obs_photon_info = my_LFI.apply_PSF(obs_photon_info, obs_info, single_energy_psf = True, single_energy_value = 5400)
        obs_photon_info = my_LFI.apply_energy_dispersion(obs_photon_info, obs_info, single_energy_ed = True, single_energy_value = 5400)
...
if (__name__=="__main__"):
    ...
    path = '/home/chri3448/EPDF_ABC/gc_jobs/simulations/run5c_nonpoisson'
